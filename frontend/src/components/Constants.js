...
const BACKEND_LOGINOUT = BACKEND + "/logInOut";
...
export {
  BACKEND_LOGIN, BACKEND_LOGINOUT, BACKEND_GET_WORD_LIST, BACKEND_GET_ALLOWED_WORD_LIST, BACKEND_GET_TREE, BACKEND_ADD_WORDS,
